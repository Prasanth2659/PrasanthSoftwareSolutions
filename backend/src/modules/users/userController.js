...
// GET /api/users — All authenticated users can see contacts for messaging
...
exports.createUser = [
  ...
  async (req, res) => {
    try {
      ...
      const user = await User.create({ name, email, password, role, company: company || undefined, phone, bio });
