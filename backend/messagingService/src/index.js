...
app.get("/health", (req, res) => {
  res.status(200).json({ success: true, message: "messagingService running", version: "1.0.0" });
});
...
server.listen(PORT, () => console.log("🚀 messagingService running on port " + PORT + " with WebSockets"));
