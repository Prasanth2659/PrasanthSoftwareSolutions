...
app.get("/health", (req, res) => {
  res.status(200).json({ success: true, message: "serviceRequestService running", version: "1.0.0" });
});
...
const server = app.listen(PORT, () => console.log("🚀 serviceRequestService running on port " + PORT));
